<template>
  <div>
    ...
    <el-table :data="data.content" :highlight-current-row="highlightCurrentRow" @selection-change="selectionChange"
      @current-change="handleCurrentChange" v-loading="loading" :element-loading-text="'拼命加载中'" :border="border"
      :stripe="stripe" :show-overflow-tooltip="showOverflowTooltip" :max-height="maxHeight" :height="height"
      ...
      <el-table-column :label="'操作'" width="185" fixed="right" v-if="showOperation" header-align="center"
        ...
        <template slot-scope="scope">
          <kt-button icon="fa fa-edit" :label="'编辑'" :perms="permsEdit" :size="size"
            @click="handleEdit(scope.$index, scope.row)" />
          <kt-button icon="fa fa-trash" :label="'删除'" :perms="permsDelete" :size="size" type="danger"
